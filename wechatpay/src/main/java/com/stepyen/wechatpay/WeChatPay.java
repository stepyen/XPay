...
public class WeChatPay {
    private static WeChatPay mWeChat;
    private Context mContext;
    private IWXAPI mIWXAPI;
    private XPay.WxPayListener mJPayListener;
    ...
    public void startWXPay(String appId, String partnerId, String prepayId,
                           String nonceStr, String timeStamp, String sign, XPay.WxPayListener listener) {
